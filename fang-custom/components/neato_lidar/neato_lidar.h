...
inline constexpr size_t LIDAR_POINTS_PER_SCAN = 1080;
inline constexpr size_t LIDAR_BYTES_PER_POINT = 5;
inline constexpr size_t LIDAR_SCAN_SIZE = LIDAR_POINTS_PER_SCAN * LIDAR_BYTES_PER_POINT;
inline constexpr size_t LIDAR_RING_SIZE = 6144;   // > 5400, marge pour header
